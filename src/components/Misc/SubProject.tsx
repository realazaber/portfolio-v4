...
export default function SubProject(props: any) {
  return (
    <div className="flex flex-col justify-center items-center hover:shadow-md hover:cursor-pointer rounded-md p-3 border-2 border-accent w-full tablet:w-1/3 desktop:w-1/4">
